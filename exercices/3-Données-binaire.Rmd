...
```{r}
url_cible <-"http://iml-science-1.ent.dfo-mpo.ca:8888/api/v1/images/142431/file"
reponse <- GET(url=url_cible, auth)
```

Si nous regardons la réponse à la requête, nous voyons que le contenu est en format binaire.
```
Response [http://stockage-vroy.ent.dfo-mpo.ca/BIIGLE/EGSL-Gasp%c3%a9sie-Concombres/IML-2024-058/IML-2024-058_001_0787.jpg]
...
```{r, image_fichier}
nom_fichier <- "IML-2024-058_001_0787.jpg"
...
```{r}
url_cible <- "http://iml-science-1.ent.dfo-mpo.ca:8888/api/v1/videos/309/file"
reponse <- GET(url = url_cible, auth)
nom_fichier <- "telecharger_video.mp4"
fichier <- file(nom_fichier, open = "wb")
writeBin((content(reponse, type = "raw")), fichier)
close(fichier)
```
